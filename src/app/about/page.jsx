    ...
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        <div className={styles.item}>
          ...
          <br /><div className={styles.title}>Who Are We?</div>
            <br />
          ...
          <br /><div className={styles.title}>Our Vision</div>
          <p className={styles.desc}>
          ...
          <br /><div className={styles.title}>Our Values</div>
          <p className={styles.desc}>
        ...
        <div className={styles.item}>
          ...
          <p className={styles.desc}>
          <br /><div className={styles.title}>Symptom-Based Disease Prediction</div>
          ...
          <br />⦾ This feature can provide valuable insights into your health and help you take appropriate actions.
            <br />
            <br /><div className={styles.title}>Nearby Health Centers Map</div>
            <br />
